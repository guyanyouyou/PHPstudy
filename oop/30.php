...
/**
 * @Author: 孤雁幽幽
 * @Date:   2016-03-30 22:35:44
 * @Last Modified by:   孤雁幽幽
 * @Last Modified time: 2016-04-01 23:52:13
 */
<?php
/****
燕十八 公益PHP讲堂
...
/*class single {
    ...
    static public function getInstance() {
        if (self::$ins instanceof self) {   //instance实例 of谁的
            return self::$ins;              //专门判断某个对象是不是某个类的实例用的
        }else{
            self::$ins = new self();
            return self::$ins;
        }
...
//clone又多出来一个对象，试问，如何解决
//提示：请看模式方法
//魔术方法很多，__construct __destruct